...
fn test_get_file_type_jpeg() {
  assert_eq!(
    get_file_type(Path::new("test.jpg")),
    Some("jpeg".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.jpeg")),
    Some("jpeg".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.JPG")),
...
fn test_get_file_type_tiff() {
  assert_eq!(
    get_file_type(Path::new("test.tif")),
    Some("tiff".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.tiff")),
    Some("tiff".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.TIF")),
...
fn test_get_file_type_dng() {
  assert_eq!(
    get_file_type(Path::new("test.dng")),
    Some("dng".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.DNG")),
...
fn test_get_file_type_raw() {
  assert_eq!(
    get_file_type(Path::new("test.cr2")),
    Some("raw".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.nef")),
    Some("raw".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.arw")),
    Some("raw".to_string())
  );
}
...
fn test_get_file_type_unsupported() {
  assert_eq!(
    get_file_type(Path::new("test.png")),
    Some("raw".to_string())
  );
  assert_eq!(
    get_file_type(Path::new("test.txt")),
    Some("raw".to_string())
  );
}
