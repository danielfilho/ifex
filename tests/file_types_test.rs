...
fn test_file_type_from_path_jpeg() {
    assert_eq!(FileType::from_path(Path::new("test.jpg")), Some(FileType::Jpeg));
    assert_eq!(FileType::from_path(Path::new("test.jpeg")), Some(FileType::Jpeg));
    assert_eq!(FileType::from_path(Path::new("test.JPG")), Some(FileType::Jpeg));
    assert_eq!(FileType::from_path(Path::new("test.JPEG")), Some(FileType::Jpeg));
}
...
fn test_file_type_from_path_tiff() {
    assert_eq!(FileType::from_path(Path::new("test.tif")), Some(FileType::Tiff));
    assert_eq!(FileType::from_path(Path::new("test.tiff")), Some(FileType::Tiff));
    assert_eq!(FileType::from_path(Path::new("test.TIF")), Some(FileType::Tiff));
    assert_eq!(FileType::from_path(Path::new("test.TIFF")), Some(FileType::Tiff));
}
...
fn test_file_type_from_path_raw() {
    assert_eq!(FileType::from_path(Path::new("test.cr2")), Some(FileType::Raw));
    assert_eq!(FileType::from_path(Path::new("test.nef")), Some(FileType::Raw));
    assert_eq!(FileType::from_path(Path::new("test.arw")), Some(FileType::Raw));
    assert_eq!(FileType::from_path(Path::new("test.orf")), Some(FileType::Raw));
    assert_eq!(FileType::from_path(Path::new("test.rw2")), Some(FileType::Raw));
    assert_eq!(FileType::from_path(Path::new("test.raf")), Some(FileType::Raw));
}
